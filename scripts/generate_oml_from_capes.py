...
class PPGInstance:
    ...
    Exemplo: Programa de Educação da UFPE (modalidade ACADÊMICA)
...
class ConceituPPGInstance:
    ...
    Exemplo: PPG_EDUCACAO_UFPE foi avaliado em:
        • 2021: conceito 5
        • 2022: conceito 5
        • 2023: conceito 5
...
class InstanceExtractor:
    ...
    def extract_icts(self) -> Dict[str, ICTInstance]:
        ...
        Exemplo:
            CD_ENTIDADE_CAPES=25001 aparece 45 vezes no dataset
            → Criamos apenas 1 ICTInstance com id="ict_25001"
    ...
    def extract_ppgs(self) -> Dict[str, PPGInstance]:
        ...
        for _, row in unique_ppgs.iterrows():
            ...
            self.ppg_instances[ppg_id] = PPGInstance(
                ...
                ict_id=ict_id  # Relacionamento: PPG sediado em ICT
            )
    ...
    def extract_conceitos(self) -> List[ConceituPPGInstance]:
        ...
        Exemplo:
            PPG_EDUCACAO_UFPE avaliado:
            • 2021 conceito 5 → conceito_25001019_2021
            • 2022 conceito 5 → conceito_25001019_2022
            • 2023 conceito 5 → conceito_25001019_2023
